...
with strategy.scope():
    model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
        verbose=1,
        filepath='./models/OPUS_KiDS_cnn_wSegmap_step5_b',
...
plt.savefig('CNN_wSegmap_step5_result.png')
#plt.show()
plt.close()

model.save_weights('./models/OPUS_KiDS_cnn_wSegmap_step5_f')
...
plt.plot([0,1],[0,1],'r')
plt.savefig('CNN_wSegmap_train_step5_f.png')
#plt.show()
plt.close()
...
plt.hexbin(true_label, pred_label, cmap='jet', gridsize=50, mincnt=1)
plt.plot([0,1],[0,1],'r')
plt.savefig('CNN_wSegmap_valid_step5_f.png')
#plt.show()
plt.close()
...
model.load_weights('./models/OPUS_KiDS_cnn_wSegmap_step5_b')
...
plt.hexbin(true_label, pred_label, cmap='jet', gridsize=50, mincnt=1)
plt.plot([0,1],[0,1],'r')
plt.savefig('CNN_wSegmap_train_step5_b.png')
#plt.show()
plt.close()
print('train mse:', mse.result())
...
plt.hexbin(true_label, pred_label, cmap='jet', gridsize=50, mincnt=1)
plt.plot([0,1],[0,1],'r')
plt.savefig('CNN_wSegmap_valid_step5_b.png')
#plt.show()
plt.close()
print('valid mse:', mse.result())
